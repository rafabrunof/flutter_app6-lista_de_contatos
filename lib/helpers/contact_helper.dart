...
class ContactHelper {
  ...
  Future<int> getNumber() async {
    Database dbContact = await db;
    return Sqflite.firstIntValue(await dbContact.rawQuery("SELECT COUNT(*) FORM $contactTable"));
  }
...
class Contact {
  ...
  @override
  String toString() {
    return "Contact (id: $id, name: $name, email: $email, telefone: $telefone, img: $img)";
  }
